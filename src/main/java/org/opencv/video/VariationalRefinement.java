 ...
 * <p>
 * This class implements variational refinement of the input flow field, i.e. it
 * uses input flow to initialize the minimization of the following functional:
 ...
 * robust penalizer to limit the influence of outliers. A complete formulation
 * and a description of the minimization procedure can be found in CITE:
 * Brox2004
 */
public class VariationalRefinement extends DenseOpticalFlow {
     ...
     * minimization procedure to solve the respective linear system. SEE:
     * setSorIterations
     *
     * @return automatically generated
     */
    ...
    //
    // C++: void cv::VariationalRefinement::calcUV(Mat I0, Mat I1, Mat& flow_u, Mat&
    // flow_v)
    //

    /**
     * REF: calc function overload to handle separate horizontal (u) and vertical
     * (v) flow components (to avoid extra splits/merges)
     *
    ...
    // C++: void cv::VariationalRefinement::calcUV(Mat I0, Mat I1, Mat& flow_u, Mat&
    // flow_v)
    private static native void calcUV_0(long nativeObj, long I0_nativeObj, long I1_nativeObj, long flow_u_nativeObj,
