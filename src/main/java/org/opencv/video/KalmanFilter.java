 ...
 * &lt;http://en.wikipedia.org/wiki/Kalman_filter&gt;, CITE: Welch95 . However,
 * you can modify transitionMatrix, controlMatrix, and measurementMatrix to get
 * an extended Kalman filter functionality. <b>Note:</b> In C API when
 * CvKalman\* kalmanFilter structure is not needed anymore, it should be
 * released with cvReleaseKalman(&amp;kalmanFilter)
 */
public class KalmanFilter {
    ...
    //
    // C++: cv::KalmanFilter::KalmanFilter(int dynamParams, int measureParams, int
     ...
     * @param type          Type of the created matrices that should be CV_32F or
     *                      CV_64F.
     */
