...
public class BackgroundSubtractorMOG2 extends BackgroundSubtractor {
    ...
    /**
     * Returns the variance threshold for the pixel-model match used for new mixture
     * component generation
     * <p>
     * Threshold for the squared Mahalanobis distance that helps decide when a
     * sample is close to the existing components (corresponds to Tg in the paper).
     * If a pixel is not close to any component, it is considered foreground or
     * added as a new component. 3 sigma =&gt; Tg=3\*3=9 is default. A smaller Tg
    ...
    //
    // C++: void cv::BackgroundSubtractorMOG2::apply(Mat image, Mat& fgmask, double
    // learningRate = -1)
    //
     ...
     *
     * @param image        Next video frame. Floating point frame will be used
     *                     without scaling and should be in range \([0,255]\).
     * @param fgmask       The output foreground mask as an 8-bit binary image.
     * @param learningRate The value between 0 and 1 that indicates how fast the
     *                     background model is learnt. Negative parameter value
     *                     makes the algorithm to use some automatically chosen
     ...
     *               scaling and should be in range \([0,255]\).
     * @param fgmask The output foreground mask as an 8-bit binary image. learnt.
     *               Negative parameter value makes the algorithm to use some
     *               automatically chosen learning rate. 0 means that the background
     *               model is not updated at all, 1 means that the background model
    ...
    //
    // C++: void
    // cv::BackgroundSubtractorMOG2::setComplexityReductionThreshold(double ct)
    //
    ...
    //
    // C++: void cv::BackgroundSubtractorMOG2::setVarThresholdGen(double
    // varThresholdGen)
    //

    /**
     * Sets the variance threshold for the pixel-model match used for new mixture
     * component generation
     *
