...
public class SparseOpticalFlow extends Algorithm {
    ...
    //
    // C++: void cv::SparseOpticalFlow::calc(Mat prevImg, Mat nextImg, Mat prevPts,
    // Mat& nextPts, Mat& status, Mat& err = cv::Mat())
    //
     ...
     * @param status  Output status vector. Each element of the vector is set to 1
    ...
    public void calc(Mat prevImg, Mat nextImg, Mat prevPts, Mat nextPts, Mat status, Mat err) {
        calc_0(nativeObj, prevImg.nativeObj, nextImg.nativeObj, prevPts.nativeObj, nextPts.nativeObj, status.nativeObj,
                err.nativeObj);
    }
    ...
    // C++: void cv::SparseOpticalFlow::calc(Mat prevImg, Mat nextImg, Mat prevPts,
    // Mat& nextPts, Mat& status, Mat& err = cv::Mat())
    private static native void calc_0(long nativeObj, long prevImg_nativeObj, long nextImg_nativeObj,
            long prevPts_nativeObj, long nextPts_nativeObj, long status_nativeObj, long err_nativeObj);

    private static native void calc_1(long nativeObj, long prevImg_nativeObj, long nextImg_nativeObj,
            long prevPts_nativeObj, long nextPts_nativeObj, long status_nativeObj);
