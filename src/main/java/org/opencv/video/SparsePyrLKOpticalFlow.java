...
public class SparsePyrLKOpticalFlow extends SparseOpticalFlow {
    ...
    //
    // C++: static Ptr_SparsePyrLKOpticalFlow
    // cv::SparsePyrLKOpticalFlow::create(Size winSize = Size(21, 21), int maxLevel
    // = 3, TermCriteria crit = TermCriteria(TermCriteria::COUNT+TermCriteria::EPS,
    ...
    public static SparsePyrLKOpticalFlow create(Size winSize, int maxLevel, TermCriteria crit, int flags,
        ...
        return SparsePyrLKOpticalFlow.__fromPtr__(create_0(winSize.width, winSize.height, maxLevel, crit.type,
                crit.maxCount, crit.epsilon, flags, minEigThreshold));
    }

    public static SparsePyrLKOpticalFlow create(Size winSize, int maxLevel, TermCriteria crit, int flags) {
        return SparsePyrLKOpticalFlow.__fromPtr__(
                create_1(winSize.width, winSize.height, maxLevel, crit.type, crit.maxCount, crit.epsilon, flags));
    }

    public static SparsePyrLKOpticalFlow create(Size winSize, int maxLevel, TermCriteria crit) {
        return SparsePyrLKOpticalFlow
                .__fromPtr__(create_2(winSize.width, winSize.height, maxLevel, crit.type, crit.maxCount, crit.epsilon));
    }
    ...
    //
    // C++: void cv::SparsePyrLKOpticalFlow::setMinEigThreshold(double
    // minEigThreshold)
    //
    ...
    // = 3, TermCriteria crit = TermCriteria(TermCriteria::COUNT+TermCriteria::EPS,
    // 30, 0.01), int flags = 0, double minEigThreshold = 1e-4)
    private static native long create_0(double winSize_width, double winSize_height, int maxLevel, int crit_type,
            int crit_maxCount, double crit_epsilon, int flags, double minEigThreshold);

    private static native long create_1(double winSize_width, double winSize_height, int maxLevel, int crit_type,
            int crit_maxCount, double crit_epsilon, int flags);

    private static native long create_2(double winSize_width, double winSize_height, int maxLevel, int crit_type,
            int crit_maxCount, double crit_epsilon);
