 ...
 * described in CITE: Zivkovic2006 . Very efficient if number of foreground
 * pixels is low.
 */
public class BackgroundSubtractorKNN extends BackgroundSubtractor {
    ...
    /**
     * Returns the threshold on the squared distance between the pixel and the
     * sample
     * <p>
    ...
    //
    // C++: void cv::BackgroundSubtractorKNN::setDist2Threshold(double
    // _dist2Threshold)
    //
