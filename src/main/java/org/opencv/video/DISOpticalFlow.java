 ...
 * between speed and quality. However, even the slowest preset is still
 * relatively fast, use DeepFlow if you need better quality and don't care about
 * speed.
 * <p>
 ...
 * vectors (REF: getUseSpatialPropagation), as well as an option to utilize an
 * initial flow approximation passed to REF: calc (which is, essentially,
 * temporal propagation, if the previous frame's flow field is passed).
 */
public class DISOpticalFlow extends DenseOpticalFlow {
     ...
     * It is turned on by default as it typically provides a noticeable quality
     * boost because of increased robustness to illumination variations. Turn it off
     * if you are certain that your sequence doesn't contain any changes in
     * illumination. SEE: setUseMeanNormalization
     *
     * @return automatically generated
     */
    ...
    /**
     * Whether to use spatial propagation of good optical flow vectors. This option
     * is turned on by default, as it tends to work better on average and can
     * sometimes help recover from major errors introduced by the coarse-to-fine
     * scheme employed by the DIS optical flow algorithm. Turning this option off
     * can make the output flow field a bit smoother, however. SEE:
    ...
    /**
     * Finest level of the Gaussian pyramid on which the flow is computed (zero
     * level corresponds to the original image resolution). The final flow is
     * obtained by bilinear upscaling. SEE: setFinestScale
     *
     * @return automatically generated
     */
    ...
    /**
     * Maximum number of gradient descent iterations in the patch inverse search
     * stage. Higher values may improve quality in some cases. SEE:
    ...
    /**
     * Size of an image patch for matching (in pixels). Normally, default 8x8
     * patches work well enough in most cases. SEE: setPatchSize
     *
     * @return automatically generated
     */
    ...
    /**
     * Stride between neighbor patches. Must be less than patch size. Lower values
     * correspond to higher flow quality. SEE: setPatchStride
     *
     * @return automatically generated
     */
    ...
    /**
     * Number of fixed point iterations of variational refinement per scale. Set to
     * zero to disable variational refinement completely. Higher values will
     * typically result in more smooth and high-quality flow. SEE:
     * setGradientDescentIterations
     *
     * @return automatically generated
     */
