...
public class BackgroundSubtractor extends Algorithm {
    ...
    //
    // C++: void cv::BackgroundSubtractor::apply(Mat image, Mat& fgmask, double
    // learningRate = -1)
    //
     ...
     *
     *                        <b>Note:</b> Sometimes the background image can be
     *                        very blurry, as it contain the average background
     *                        statistics.
     */
