 ...
 * interface: SNIPPET: snippets/core_various.cpp Algorithm
 */
public class Algorithm {
    ...
    /**
     * Returns the algorithm string identifier. This string is used as top level
     * xml/yml node tag when the object is saved to a file or string.
     *
    ...
    /**
     * Returns true if the Algorithm is empty (e.g. in the very beginning or after
     * unsuccessful read
     *
     * @return automatically generated
     */
    ...
    /**
     * Saves the algorithm to a file. In order to make this method work, the derived
     * class must implement Algorithm::write(FileStorage&amp; fs).
     *
