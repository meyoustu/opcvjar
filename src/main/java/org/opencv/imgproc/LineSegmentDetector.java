...
public class LineSegmentDetector extends Algorithm {
    ...
    //
    // C++: int cv::LineSegmentDetector::compareSegments(Size size, Mat lines1, Mat
    // lines2, Mat& _image = Mat())
    //

    /**
     * Draws two groups of lines in blue and red, counting the non overlapping
     * (mismatching) pixels.
     *
     ...
     *               be color(3-channel) in order for lines1 and lines2 to be drawn
     ...
     * @param lines1 The first group of lines that needs to be drawn. It is
     *               visualized in blue color.
     * @param lines2 The second group of lines. They visualized in red color. in
     *               order for lines1 and lines2 to be drawn in the above mentioned
     *               colors.
     * @return automatically generated
     */
    ...
    //
    // C++: void cv::LineSegmentDetector::detect(Mat _image, Mat& _lines, Mat& width
    // = Mat(), Mat& prec = Mat(), Mat& nfa = Mat())
    //
     ...
     *               and ending point of a line. Where Vec4i/Vec4f is (x1, y1, x2,
     *               y2), point 1 is the start, point 2 - end. Returned lines are
     *               strictly oriented depending on the gradient.
     ...
     *               <li>1 corresponds to 0.1 mean false alarms This vector will be
     *               calculated only when the objects type is #LSD_REFINE_ADV.</li>
     *               </ul>
     */
     ...
     * @param width  Vector of widths of the regions, where the lines are found.
     *               E.g. Width of line.
     * @param prec   Vector of precisions with which the lines are found. bigger the
     ...
     *               strictly oriented depending on the gradient.
     * @param width  Vector of widths of the regions, where the lines are found.
     *               E.g. Width of line. bigger the value, logarithmically better
     *               the detection.
     *               <ul>
     *               <li>-1 corresponds to 10 mean false alarms</li>
     *               <li>0 corresponds to 1 mean false alarm</li>
     ...
     *               and ending point of a line. Where Vec4i/Vec4f is (x1, y1, x2,
     *               y2), point 1 is the start, point 2 - end. Returned lines are
     *               strictly oriented depending on the gradient. bigger the value,
    ...
    private static native void detect_2(long nativeObj, long _image_nativeObj, long _lines_nativeObj,
