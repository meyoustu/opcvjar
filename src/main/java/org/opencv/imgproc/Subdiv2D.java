...
public class Subdiv2D {
     ...
     *             to the subdivision.
     *             <p>
     *             The function creates an empty Delaunay subdivision where 2D
     *             points can be added using the function insert() . All of the
    ...
    /**
     * creates an empty Subdiv2D object. To create a new empty Delaunay subdivision
     * you need to use the #initDelaunay function.
     */
    public Subdiv2D() {
     ...
     *                  <p>
     *                  The function is another function that locates the input
     *                  point within the subdivision. It finds the subdivision
     *                  vertex that is the closest to the input point. It is not
     *                  necessarily one of vertices of the facet containing the
     *                  input point, though the facet (located using locate() ) is
     ...
     *           within the subdivision. It finds the subdivision vertex that is the
     *           closest to the input point. It is not necessarily one of vertices
     *           of the facet containing the input point, though the facet (located
     *           using locate() ) is used as a starting point.
     * @return vertex ID.
     */
     ...
     *                     <ul>
     *                     <li>NEXT_AROUND_ORG next around the edge origin ( eOnext
     *                     on the picture below if e is the input edge)</li>
     *                     <li>NEXT_AROUND_DST next around the edge vertex ( eDnext
     *                     )</li>
     *                     <li>PREV_AROUND_ORG previous around the edge origin
     *                     (reversed eRnext )</li>
     *                     <li>PREV_AROUND_DST previous around the edge destination
     *                     (reversed eLnext )</li>
     *                     <li>NEXT_AROUND_LEFT next around the left facet ( eLnext
     *                     )</li>
     *                     <li>NEXT_AROUND_RIGHT next around the right facet (
     *                     eRnext )</li>
     *                     <li>PREV_AROUND_LEFT previous around the left facet
     *                     (reversed eOnext )</li>
     *                     <li>PREV_AROUND_RIGHT previous around the right facet
     *                     (reversed eDnext )</li>
     *                     </ul>
     *                     <p>
     ...
     *           <p>
     *           The function inserts a single point into a subdivision and modifies
     *           the subdivision topology appropriately. If a point with the same
     *           coordinates exists already, no new point is added.
     * @return the ID of the point.
     *
     *         <b>Note:</b> If the point is outside of the triangulation specified
     ...
     * @return an integer which specify one of the following five cases for point
     *         location:
     *         <ul>
     *         <li>The point falls into some facet. The function returns
     *         #PTLOC_INSIDE and edge will contain one of edges of the facet.</li>
     *         <li>The point falls onto the edge. The function returns
     *         #PTLOC_ON_EDGE and edge will contain this edge.</li>
     *         <li>The point coincides with one of the subdivision vertices. The
     *         function returns #PTLOC_VERTEX and vertex will contain a pointer to
     *         the vertex.</li>
     *         <li>The point is outside the subdivision reference rectangle. The
     *         function returns #PTLOC_OUTSIDE_RECT and no pointers are filled.</li>
     *         <li>One of input arguments is invalid. A runtime error is raised or,
     *         if silent or "parent" error processing mode is selected, #PTLOC_ERROR
     *         is returned.</li>
     *         </ul>
     */
     ...
     *
     * @param edge Subdivision edge ID.
     * @return an integer which is next edge ID around the edge origin: eOnext on
     ...
     *               <ul>
     *               <li>0 - the input edge ( e on the picture below if e is the
     *               input edge)</li>
     ...
     *                 each two are one of the edge vertices. i.e. org_x = v[0],
     ...
     *                     <p>
     *                     The function gives each triangle as a 6 numbers vector,
     *                     where each two are one of the triangle vertices. i.e.
     *                     p1_x = v[0], p1_y = v[1], p2_x = v[2], p2_y = v[3], p3_x
     *                     = v[4], p3_y = v[5].
     */
    ...
    //
    // C++: void cv::Subdiv2D::getVoronoiFacetList(vector_int idx,
     ...
     *
     * @param idx          Vector of vertices IDs to consider. For all vertices you
     *                     can pass empty vector.
     ...
     *              <p>
     *              The function inserts a vector of points into a subdivision and
