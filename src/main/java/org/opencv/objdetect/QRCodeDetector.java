...
/**
 * Groups the object candidate rectangles. rectList Input/output vector of
 * rectangles. Output vector includes retained and grouped rectangles. (The
 * Python list is not modified in place.) weights Input/output vector of weights
 * of rectangles. Output vector includes weights of retained and grouped
 ...
 * group of rectangles to retain it. eps Relative difference between sides of
 * the rectangles to merge them into a group.
 */
public class QRCodeDetector {
    ...
    //
    // C++: bool cv::QRCodeDetector::decodeMulti(Mat img, Mat points, vector_string&
    // decoded_info, vector_Mat& straight_qrcode = vector_Mat())
    //
     ...
     * @param decoded_info    UTF8-encoded output vector of string or empty vector
     *                        of string if the codes cannot be decoded.
     * @param points          vector of Quadrangle vertices found by detect() method
     *                        (or some other algorithm).
     * @param straight_qrcode The optional output vector of images containing
     *                        rectified and binarized QR codes
    ...
    public boolean decodeMulti(Mat img, Mat points, List<String> decoded_info, List<Mat> straight_qrcode) {
        ...
        boolean retVal = decodeMulti_0(nativeObj, img.nativeObj, points.nativeObj, decoded_info,
     ...
     *
     * @param img          grayscale or color (BGR) image containing QR codes.
     * @param decoded_info UTF8-encoded output vector of string or empty vector of
     *                     string if the codes cannot be decoded.
     * @param points       vector of Quadrangle vertices found by detect() method
     *                     (or some other algorithm).
     * @return automatically generated
     */
    ...
    //
    // C++: bool cv::QRCodeDetector::detectAndDecodeMulti(Mat img, vector_string&
    // decoded_info, Mat& points = Mat(), vector_Mat& straight_qrcode =
    // vector_Mat())
    //
     ...
     * @param decoded_info    UTF8-encoded output vector of string or empty vector
     *                        of string if the codes cannot be decoded.
     * @param points          optional output vector of vertices of the found QR
     *                        code quadrangles. Will be empty if not found.
     * @param straight_qrcode The optional output vector of images containing
     *                        rectified and binarized QR codes
     * @return automatically generated
     */
    public boolean detectAndDecodeMulti(Mat img, List<String> decoded_info, Mat points, List<Mat> straight_qrcode) {
        Mat straight_qrcode_mat = new Mat();
        boolean retVal = detectAndDecodeMulti_0(nativeObj, img.nativeObj, decoded_info, points.nativeObj,
                straight_qrcode_mat.nativeObj);
        Converters.Mat_to_vector_Mat(straight_qrcode_mat, straight_qrcode);
        straight_qrcode_mat.release();
        return retVal;
     ...
     * @param decoded_info UTF8-encoded output vector of string or empty vector of
     *                     string if the codes cannot be decoded.
     * @param points       optional output vector of vertices of the found QR code
     *                     quadrangles. Will be empty if not found.
     * @return automatically generated
     */
    ...
    /**
     * Detects QR codes in image and returns the vector of the quadrangles
     * containing the codes.
     *
     * @param img    grayscale or color (BGR) image containing (or not) QR codes.
     * @param points Output vector of vector of vertices of the minimum-area
     *               quadrangle containing the codes.
     * @return automatically generated
     */
    ...
    //
    // C++: string cv::QRCodeDetector::decode(Mat img, Mat points, Mat&
    // straight_qrcode = Mat())
    //
     ...
     * @param points          Quadrangle vertices found by detect() method (or some
     *                        other algorithm).
    ...
    //
    // C++: string cv::QRCodeDetector::detectAndDecode(Mat img, Mat& points = Mat(),
    // Mat& straight_qrcode = Mat())
    //
     ...
     *
     * @param img             grayscale or color (BGR) image containing QR code.
     * @param points          optional output array of vertices of the found QR code
     ...
     *             horizontal pattern of the scheme 1:1:3:1:1 according to QR code
     *             standard.
     */
     ...
     * detection.
     *
     * @param epsY Epsilon neighborhood, which allows you to determine the vertical
     *             pattern of the scheme 1:1:3:1:1 according to QR code standard.
     */
    ...
    private static native boolean decodeMulti_0(long nativeObj, long img_nativeObj, long points_nativeObj,
            List<String> decoded_info, long straight_qrcode_mat_nativeObj);

    private static native boolean decodeMulti_1(long nativeObj, long img_nativeObj, long points_nativeObj,
    ...
    // decoded_info, Mat& points = Mat(), vector_Mat& straight_qrcode =
    // vector_Mat())
    private static native boolean detectAndDecodeMulti_0(long nativeObj, long img_nativeObj, List<String> decoded_info,
            long points_nativeObj, long straight_qrcode_mat_nativeObj);

    private static native boolean detectAndDecodeMulti_1(long nativeObj, long img_nativeObj, List<String> decoded_info,
    ...
    private static native String decode_0(long nativeObj, long img_nativeObj, long points_nativeObj,
            long straight_qrcode_nativeObj);
