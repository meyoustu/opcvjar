 ...
 * decision tree, however the class is capable of storing multiple decision
 * trees and using them for prediction (by summing responses or using a voting
 * schemes), and the derived from DTrees classes (such as RTrees and Boost) use
 * this capability to implement decision tree ensembles.
 * <p>
...
public class DTrees extends StatModel {
    ...
    //
    // C++: static Ptr_DTrees cv::ml::DTrees::load(String filepath, String nodeName
    // = String())
    //
     ...
     * <p>
     * Use DTree::save to serialize and store an DTree to disk. Load the DTree from
