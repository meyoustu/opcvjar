...
public class SVMSGD extends StatModel {
    ...
    /**
     * Creates empty model. Use StatModel::train to train the model. Since %SVMSGD
     * has several parameters, you may want to find the best parameters for your
     * problem or use setOptimalParameters() to set some default parameters.
     *
    ...
    //
    // C++: static Ptr_SVMSGD cv::ml::SVMSGD::load(String filepath, String nodeName
    // = String())
    //
     ...
     * <p>
     * Use SVMSGD::save to serialize and store an SVMSGD to disk. Load the SVMSGD
     * from this file again, by calling this function with the path to the file.
    ...
    /**
     * @return the shift of the trained model (decision function f(x) = weights * x
     *         + shift).
     */
    ...
    //
    // C++: void cv::ml::SVMSGD::setOptimalParameters(int svmsgdType = SVMSGD::ASGD,
