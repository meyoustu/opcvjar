...
public class LogisticRegression extends StatModel {
     ...
     * <p>
     * For a two class classification problem, it returns a row matrix. It returns
    ...
    //
    // C++: static Ptr_LogisticRegression cv::ml::LogisticRegression::load(String
    // filepath, String nodeName = String())
    //

    /**
     * Loads and creates a serialized LogisticRegression from a file
     * <p>
     * Use LogisticRegression::save to serialize and store an LogisticRegression to
     * disk. Load the LogisticRegression from this file again, by calling this
     * function with the path to the file. Optionally specify the node for the file
    ...
    //
    // C++: float cv::ml::LogisticRegression::predict(Mat samples, Mat& results =
    // Mat(), int flags = 0)
    //
     ...
     *                where each row contains variables (features) of one object
     *                being classified. Should have data type CV_32F.
