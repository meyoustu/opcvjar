 ...
 * ANN_MLP::create. All the weights are set to zeros. Then, the network is
...
public class ANN_MLP extends StatModel {
    ...
    /**
     * Integer vector specifying the number of neurons in each layer including the
     * input and output layers. The very first element specifies the number of
     * elements in the input layer. The last element - number of elements in the
     * output layer. SEE: setLayerSizes
     *
     ...
     * <p>
     * Use ANN::save to serialize and store an ANN to disk. Load the ANN from this
    ...
    //
    // C++: void cv::ml::ANN_MLP::setActivationFunction(int type, double param1 = 0,
    // double param2 = 0)
    //

    /**
     * Initialize the activation function for each neuron. Currently the default and
     * the only fully supported activation function is ANN_MLP::SIGMOID_SYM.
     *
     * @param type   The type of activation function. See
     *               ANN_MLP::ActivationFunctions.
     * @param param1 The first parameter of the activation function, \(\alpha\).
     *               Default value is 0.
     * @param param2 The second parameter of the activation function, \(\beta\).
     *               Default value is 0.
     */
     ...
     * input and output layers. The very first element specifies the number of
     * elements in the input layer. The last element - number of elements in the
     * output layer. Default value is empty Mat. SEE: getLayerSizes
     *
    ...
    //
    // C++: void cv::ml::ANN_MLP::setTrainMethod(int method, double param1 = 0,
    // double param2 = 0)
    //
     ...
     *               setBackpropWeightScale for ANN_MLP::BACKPROP and to initialT
     *               for ANN_MLP::ANNEAL.
     * @param param2 passed to setRpropDWMin for ANN_MLP::RPROP and to
     *               setBackpropMomentumScale for ANN_MLP::BACKPROP and to finalT
     *               for ANN_MLP::ANNEAL.
     */
