...
public class NormalBayesClassifier extends StatModel {
    ...
    //
    // C++: static Ptr_NormalBayesClassifier
    // cv::ml::NormalBayesClassifier::load(String filepath, String nodeName =
    // String())
    //
     ...
     * NormalBayesClassifier to disk. Load the NormalBayesClassifier from this file
    ...
    //
    // C++: float cv::ml::NormalBayesClassifier::predictProb(Mat inputs, Mat&
    // outputs, Mat& outputProbs, int flags = 0)
    //
