 ...
 * SegmentationModel creates net from file with trained weights and config, sets
 * preprocessing input, runs forward pass and returns the class prediction for
 * each pixel.
 */
public class SegmentationModel extends Model {
    ...
    //
    // C++: cv::dnn::SegmentationModel::SegmentationModel(String model, String
    // config = "")
    //

    /**
     * Create segmentation model from network represented in one of the supported
