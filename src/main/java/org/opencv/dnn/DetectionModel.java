 ...
 * DetectionModel creates net from file with trained weights and config, sets
 * preprocessing input, runs forward pass and return result detections. For
 * DetectionModel SSD, Faster R-CNN, YOLO topologies are supported.
 */
public class DetectionModel extends Model {
    ...
    /**
     * Create detection model from network represented in one of the supported
    ...
    //
    // C++: void cv::dnn::DetectionModel::detect(Mat frame, vector_int& classIds,
    // vector_float& confidences, vector_Rect& boxes, float confThreshold = 0.5f,
    // float nmsThreshold = 0.0f)
    //

    /**
     * Given the {@code input} frame, create input blob, run net and return result
     * detections.
     *
    ...
    public void detect(Mat frame, MatOfInt classIds, MatOfFloat confidences, MatOfRect boxes, float confThreshold,
        ...
        Mat boxes_mat = boxes;
        detect_0(nativeObj, frame.nativeObj, classIds_mat.nativeObj, confidences_mat.nativeObj, boxes_mat.nativeObj,
    ...
    public void detect(Mat frame, MatOfInt classIds, MatOfFloat confidences, MatOfRect boxes, float confThreshold) {
        ...
        Mat confidences_mat = confidences;
        Mat boxes_mat = boxes;
        detect_1(nativeObj, frame.nativeObj, classIds_mat.nativeObj, confidences_mat.nativeObj, boxes_mat.nativeObj,
                confThreshold);
    }
    ...
    // vector_float& confidences, vector_Rect& boxes, float confThreshold = 0.5f,
    // float nmsThreshold = 0.0f)
    private static native void detect_0(long nativeObj, long frame_nativeObj, long classIds_mat_nativeObj,
            long confidences_mat_nativeObj, long boxes_mat_nativeObj, float confThreshold, float nmsThreshold);

    private static native void detect_1(long nativeObj, long frame_nativeObj, long classIds_mat_nativeObj,
            long confidences_mat_nativeObj, long boxes_mat_nativeObj, float confThreshold);

    private static native void detect_2(long nativeObj, long frame_nativeObj, long classIds_mat_nativeObj,
            long confidences_mat_nativeObj, long boxes_mat_nativeObj);
