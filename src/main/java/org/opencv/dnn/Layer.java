...
/**
 * This interface class allows to build new Layers - are building blocks of
 * networks.
 * <p>
 * Each class, derived from Layer, must implement allocate() methods to declare
 * own outputs and forward() to compute outputs. Also before using the new layer
 * into networks you must register your layer by using one of REF:
 * dnnLayerFactory "LayerFactory" macros.
 */
public class Layer extends Algorithm {
     ...
     *                <p>
     *                If this method is called after network has allocated all
     *                memory for input and output blobs and before inferencing.
    ...
    //
    // C++: void cv::dnn::Layer::run(vector_Mat inputs, vector_Mat& outputs,
    ...
    // run_0(nativeObj, inputs_mat.nativeObj, outputs_mat.nativeObj,
    // internals_mat.nativeObj);
    // Converters.Mat_to_vector_Mat(outputs_mat, outputs);
    // outputs_mat.release();
    ...
    // C++: void cv::dnn::Layer::run(vector_Mat inputs, vector_Mat& outputs,
    // vector_Mat& internals)
    private static native void run_0(long nativeObj, long inputs_mat_nativeObj, long outputs_mat_nativeObj,
