...
public class ClassificationModel extends Model {
    ...
    //
    // C++: cv::dnn::ClassificationModel::ClassificationModel(String model, String
    // config = "")
    //

    /**
     * Create classification model from network represented in one of the supported
    ...
    //
    // C++: void cv::dnn::ClassificationModel::classify(Mat frame, int& classId,
    // float& conf)
    //
    ...
    // C++: void cv::dnn::ClassificationModel::classify(Mat frame, int& classId,
    // float& conf)
    private static native void classify_0(long nativeObj, long frame_nativeObj, double[] classId_out,
            double[] conf_out);
