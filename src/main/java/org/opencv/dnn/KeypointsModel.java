 ...
 * KeypointsModel creates net from file with trained weights and config, sets
 * preprocessing input, runs forward pass and returns the x and y coordinates of
...
public class KeypointsModel extends Model {
    ...
    /**
     * Create keypoints model from network represented in one of the supported
    ...
    //
    // C++: vector_Point2f cv::dnn::KeypointsModel::estimate(Mat frame, float thresh
    // = 0.5)
    //
