...
public class StereoBM extends StereoMatcher {
    ...
    //
    // C++: static Ptr_StereoBM cv::StereoBM::create(int numDisparities = 0, int
    // blockSize = 21)
    //
     ...
     *                       disparity) to numDisparities. The search range can then
     *                       be shifted by changing the minimum disparity.
     * @param blockSize      the linear size of the blocks compared by the
     ...
     *                       StereoBM::compute() to compute disparity for a specific
     *                       stereo pair.
     ...
     *                       will find the best disparity from 0 (default minimum
     *                       disparity) to numDisparities. The search range can then
     *                       be shifted by changing the minimum disparity. (as the
     *                       block is centered at the current pixel). Larger block
     *                       size implies smoother, though less accurate disparity
     *                       map. Smaller block size gives more detailed disparity
     *                       map, but there is higher chance for algorithm to find a
     *                       wrong correspondence.
     *                       <p>
     *                       The function create StereoBM object. You can then call
     *                       StereoBM::compute() to compute disparity for a specific
     ...
     * Creates StereoBM object
     * <p>
     * disparity from 0 (default minimum disparity) to numDisparities. The search
     * range can then be shifted by changing the minimum disparity. (as the block is
     * centered at the current pixel). Larger block size implies smoother, though
     * less accurate disparity map. Smaller block size gives more detailed disparity
     * map, but there is higher chance for algorithm to find a wrong correspondence.
     * <p>
     * The function create StereoBM object. You can then call StereoBM::compute() to
     * compute disparity for a specific stereo pair.
     *
     * @return automatically generated
     */
