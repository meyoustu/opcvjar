...
public class StereoMatcher extends Algorithm {
     ...
     *                  images. Some algorithms, like StereoBM or StereoSGBM compute
     *                  16-bit fixed-point disparity map (where each disparity value
     *                  has 4 fractional bits), whereas other algorithms output
     *                  32-bit floating-point disparity map.
     */
