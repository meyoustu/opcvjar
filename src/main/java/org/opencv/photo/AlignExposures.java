...
/**
 * The base class for algorithms that align images of the same scene with
 * different exposures
 */
public class AlignExposures extends Algorithm {
    ...
    //
    // C++: void cv::AlignExposures::process(vector_Mat src, vector_Mat dst, Mat
    // times, Mat response)
    //
     ...
     *                 pixel value, it should have the same number of channels as
     *                 images.
     */
