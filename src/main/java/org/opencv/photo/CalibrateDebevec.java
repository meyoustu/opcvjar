...
/**
 * Inverse camera response function is extracted for each brightness value by
 * minimizing an objective function as linear system. Objective function is
 * constructed using pixel values on the same position in all images, extra term
