...
/**
 * The resulting HDR image is calculated as weighted average of the exposures
 * considering exposure values and camera response.
 * <p>
...
public class MergeDebevec extends MergeExposures {
    ...
    //
    // C++: void cv::MergeDebevec::process(vector_Mat src, Mat& dst, Mat times, Mat
    // response)
    //
