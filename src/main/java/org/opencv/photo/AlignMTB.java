...
public class AlignMTB extends AlignExposures {
    ...
    /**
     * Calculates shift between two images, i. e. how to shift the second image to
     * correspond it with the first.
     *
    ...
    //
    // C++: void cv::AlignMTB::process(vector_Mat src, vector_Mat dst, Mat times,
    // Mat response)
    //
