...
/**
 * Pixels are weighted using contrast, saturation and well-exposedness measures,
 * than images are combined using laplacian pyramids.
 * <p>
...
public class MergeMertens extends MergeExposures {
    ...
    //
    // C++: void cv::MergeMertens::process(vector_Mat src, Mat& dst, Mat times, Mat
    // response)
    //
