...
public class Feature2D extends Algorithm {
    ...
    //
    // C++: void cv::Feature2D::compute(Mat image, vector_KeyPoint& keypoints, Mat&
    // descriptors)
    //
     ...
     *                    keypoints can be added, for example: SIFT duplicates
     ...
     *                    descriptors[i] are descriptors computed for a
     *                    keypoints[i]. Row j is the keypoints (or keypoints[i]) is
     *                    the descriptor for keypoint j-th keypoint.
     */
    ...
    //
    // C++: void cv::Feature2D::compute(vector_Mat images, vector_vector_KeyPoint&
    ...
    //
    // C++: void cv::Feature2D::detect(Mat image, vector_KeyPoint& keypoints, Mat
    // mask = Mat())
    //
     ...
     *                  must be a 8-bit integer matrix with non-zero values in the
     *                  region of interest.
     */
    ...
    // keypoints, vector_Mat masks = vector_Mat())
    //
    ...
    //
    // C++: void cv::Feature2D::detectAndCompute(Mat image, Mat mask,
    // vector_KeyPoint& keypoints, Mat& descriptors, bool useProvidedKeypoints =
    // false)
    //
    ...
    // vector_KeyPoint& keypoints, Mat& descriptors, bool useProvidedKeypoints =
    // false)
    private static native void detectAndCompute_0(long nativeObj, long image_nativeObj, long mask_nativeObj,
            long keypoints_mat_nativeObj, long descriptors_nativeObj, boolean useProvidedKeypoints);

    private static native void detectAndCompute_1(long nativeObj, long image_nativeObj, long mask_nativeObj,
            long keypoints_mat_nativeObj, long descriptors_nativeObj);
