...
/**
 * Class implementing the BRISK keypoint detector and descriptor extractor,
 * described in CITE: LCS11 .
 */
public class BRISK extends Feature2D {
    ...
    //
    // C++: static Ptr_BRISK cv::BRISK::create(int thresh, int octaves, vector_float
    // radiusList, vector_int numberList, float dMax = 5.85f, float dMin = 8.2f,
    ...
    public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList, float dMax,
            float dMin, MatOfInt indexChange) {
        Mat radiusList_mat = radiusList;
        Mat numberList_mat = numberList;
        Mat indexChange_mat = indexChange;
        return BRISK.__fromPtr__(create_0(thresh, octaves, radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax,
                dMin, indexChange_mat.nativeObj));
    }
    ...
    public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList, float dMax,
        ...
        Mat numberList_mat = numberList;
        return BRISK
                .__fromPtr__(create_1(thresh, octaves, radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax, dMin));
    }
     ...
     *                   circle. Must be the same size as radiusList..
     * @param dMax       threshold for the short pairings used for descriptor
     *                   formation (in pixels for keypoint scale 1). keypoint scale
     *                   1).
     * @return automatically generated
     */
    public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList, float dMax) {
     ...
     *                   keypoint are taken (for keypoint scale 1).
     * @param numberList defines the number of sampling points on the sampling
     *                   circle. Must be the same size as radiusList.. scale 1).
     *                   keypoint scale 1).
     * @return automatically generated
     */
    ...
    //
    // C++: static Ptr_BRISK cv::BRISK::create(int thresh = 30, int octaves = 3,
    ...
    //
    // C++: static Ptr_BRISK cv::BRISK::create(vector_float radiusList, vector_int
    // numberList, float dMax = 5.85f, float dMin = 8.2f, vector_int indexChange =
    // std::vector<int>())
    //
    ...
    public static BRISK create(MatOfFloat radiusList, MatOfInt numberList, float dMax, float dMin,
        ...
        return BRISK.__fromPtr__(
                create_8(radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax, dMin, indexChange_mat.nativeObj));
    }
    ...
    // radiusList, vector_int numberList, float dMax = 5.85f, float dMin = 8.2f,
    // vector_int indexChange = std::vector<int>())
    private static native long create_0(int thresh, int octaves, long radiusList_mat_nativeObj,
            long numberList_mat_nativeObj, float dMax, float dMin, long indexChange_mat_nativeObj);

    private static native long create_1(int thresh, int octaves, long radiusList_mat_nativeObj,
            long numberList_mat_nativeObj, float dMax, float dMin);

    private static native long create_2(int thresh, int octaves, long radiusList_mat_nativeObj,
            long numberList_mat_nativeObj, float dMax);

    private static native long create_3(int thresh, int octaves, long radiusList_mat_nativeObj,
    ...
    // numberList, float dMax = 5.85f, float dMin = 8.2f, vector_int indexChange =
    // std::vector<int>())
    private static native long create_8(long radiusList_mat_nativeObj, long numberList_mat_nativeObj, float dMax,
            float dMin, long indexChange_mat_nativeObj);

    private static native long create_9(long radiusList_mat_nativeObj, long numberList_mat_nativeObj, float dMax,
            float dMin);
