...
public class GFTTDetector extends Feature2D {
    ...
    //
    // C++: static Ptr_GFTTDetector cv::GFTTDetector::create(int maxCorners, double
    // qualityLevel, double minDistance, int blockSize, int gradiantSize, bool
    ...
    public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize,
            int gradiantSize, boolean useHarrisDetector, double k) {
        return GFTTDetector.__fromPtr__(
                create_0(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize, useHarrisDetector, k));
    }

    public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize,
            int gradiantSize, boolean useHarrisDetector) {
        return GFTTDetector.__fromPtr__(
                create_1(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize, useHarrisDetector));
    }
    ...
    //
    // C++: static Ptr_GFTTDetector cv::GFTTDetector::create(int maxCorners = 1000,
    // double qualityLevel = 0.01, double minDistance = 1, int blockSize = 3, bool
    // useHarrisDetector = false, double k = 0.04)
    //
    ...
    public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize,
        ...
        return GFTTDetector
                .__fromPtr__(create_3(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector, k));
    }
    ...
    // qualityLevel, double minDistance, int blockSize, int gradiantSize, bool
    // useHarrisDetector = false, double k = 0.04)
    private static native long create_0(int maxCorners, double qualityLevel, double minDistance, int blockSize,
            int gradiantSize, boolean useHarrisDetector, double k);

    private static native long create_1(int maxCorners, double qualityLevel, double minDistance, int blockSize,
            int gradiantSize, boolean useHarrisDetector);
    ...
    // double qualityLevel = 0.01, double minDistance = 1, int blockSize = 3, bool
    // useHarrisDetector = false, double k = 0.04)
    private static native long create_3(int maxCorners, double qualityLevel, double minDistance, int blockSize,
            boolean useHarrisDetector, double k);

    private static native long create_4(int maxCorners, double qualityLevel, double minDistance, int blockSize,
            boolean useHarrisDetector);
