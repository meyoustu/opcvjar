...
public class BOWKMeansTrainer extends BOWTrainer {
    ...
    //
    // C++: cv::BOWKMeansTrainer::BOWKMeansTrainer(int clusterCount, TermCriteria
    ...
    // C++: cv::BOWKMeansTrainer::BOWKMeansTrainer(int clusterCount, TermCriteria
    // termcrit = TermCriteria(), int attempts = 3, int flags = KMEANS_PP_CENTERS)
    private static native long BOWKMeansTrainer_0(int clusterCount, int termcrit_type, int termcrit_maxCount,
            double termcrit_epsilon, int attempts, int flags);

    private static native long BOWKMeansTrainer_1(int clusterCount, int termcrit_type, int termcrit_maxCount,
            double termcrit_epsilon, int attempts);

    private static native long BOWKMeansTrainer_2(int clusterCount, int termcrit_type, int termcrit_maxCount,
