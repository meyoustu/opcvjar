...
/**
 * Abstract base class for training the *bag of visual words* vocabulary from a
 * set of descriptors.
 * <p>
 * For details, see, for example, *Visual Categorization with Bags of Keypoints*
 * by Gabriella Csurka, Christopher R. Dance, Lixin Fan, Jutta Willamowski,
 * Cedric Bray, 2004. :
 */
public class BOWTrainer {
     ...
     *                    is a descriptor. Descriptors are not added to the inner
     *                    train descriptor set.
     *                    <p>
     *                    The vocabulary consists of cluster centers. So, this
     *                    method returns the vocabulary. In the first variant of the
     *                    method, train descriptors stored in the object are
     *                    clustered. In the second variant, input descriptors are
     *                    clustered.
     ...
     *                    <p>
     *                    The training set is clustered using clustermethod to
