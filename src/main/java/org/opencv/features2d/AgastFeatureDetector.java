...
public class AgastFeatureDetector extends Feature2D {
    ...
    //
    // C++: static Ptr_AgastFeatureDetector cv::AgastFeatureDetector::create(int
    // threshold = 10, bool nonmaxSuppression = true,
    ...
    //
    // C++: void cv::AgastFeatureDetector::setType(AgastFeatureDetector_DetectorType
    // type)
    //
